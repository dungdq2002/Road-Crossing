...
#define SELCOLOR sf::Color::Blue
#define DEFCOLOR sf::Color::White
...
void Menu::add(std::string s) {
    ...
    auto color = (id == 0 ? sf::Color::Blue : sf::Color::White);
    current.setCharacterSize(50);
...
void Menu::moveUp() {
    ...
    menu[cursor].setFillColor(sf::Color::Blue);
}
